...
public final class CustomerServiceClient {
    ...
    public static void main(String args[]) throws Exception {
       ...
       //Configuring the CXF logging interceptor for the incoming response
         ...
         getClient = getClient.accept("application/json").type("application/json").path("/customerservice/customer/sonialin");
        ...
        *****************************************************************************************/
        ...
        customerRequest.setCustomerUsername("abc123");
        customerRequest.setCustomerEmail("abc123@luc.edu");
        customerRequest.setCustomerPassword("12345678");
        customerRequest.setCustomerFirstname("John");
        customerRequest.setCustomerLastname("Doe");
        ...
        *****************************************************************************************/
        ...
        // change application/xml  to application/json get in json format
        deleteClient = deleteClient.accept("application/xml").type("application/json").path("/customerservice/customer/abc123");
